<template>
    ...
    <div class="column">
      ...
      <section class="section" id="notifications">
        ...
        <div class="columns">
          <div class="column">
            ...
            <div class="notification is-primary">
              <button class="delete"> </button> Primar lorem ipsum dolor sit amet,
              <a href="#">consectetur</a> adipiscing elit lorem ipsum dolor sit amet, consectetur adipiscing elit </div>
            <div class="notification is-info">
              <button class="delete"> </button> Info lorem ipsum dolor sit amet,
              <a href="#">consectetur</a> adipiscing elit lorem ipsum dolor sit amet, consectetur adipiscing elit </div>
          </div>
          <div class="column">
            <div class="notification is-success">
              <button class="delete"> </button> Success lorem ipsum dolor sit amet,
              <a href="#">consectetur</a> adipiscing elit lorem ipsum dolor sit amet, consectetur adipiscing elit </div>
            <div class="notification is-warning">
              <button class="delete"> </button> Warning lorem ipsum dolor sit amet,
              <a href="#">consectetur</a> adipiscing elit lorem ipsum dolor sit amet, consectetur adipiscing elit </div>
            <div class="notification is-danger">
              <button class="delete"> </button> Danger lorem ipsum dolor sit amet,
              <a href="#">consectetur</a> adipiscing elit lorem ipsum dolor sit amet, consectetur adipiscing elit </div>
          </div>
        </div>
      </section>
      <section class="section" id="progress">
        ...
        <progress class="progress is-primary" max="100" value="30"> 30% </progress>
        <progress class="progress is-info" max="100" value="45"> 45% </progress>
        <progress class="progress is-success" max="100" value="60"> 60% </progress>
        <progress class="progress is-warning" max="100" value="75"> 75% </progress>
        <progress class="progress is-danger" max="100" value="90"> 90% </progress>
      ...
      <section class="section" id="nav">
        ...
        <nav class="nav">
          <div class="nav-left">
            <a class="nav-item"> <img src="http://bulma.io/images/bulma-logo.png" alt="Bulma logo"> </a>
          </div>
